...
export default class GamePageWholesaler extends React.Component {
    constructor(props) {
      super(props);
        ...
        <div>
            <Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
                <Tab eventKey="home" title="Current Week">
                    <SubHeading>Game Screen for Wholesaler</SubHeading>
                    <Container style={{border: "1px solid #cecece"}}>
                        <Row style={{padding: "10px 0px"}}>
                            <Col style={{textAlign: "center"}}>Demand from Retailer: <b>0</b></Col>
                    ...
                    <Info>Units Shipped to Retailer this week: <Data blue={true}>0</Data></Info>
                    <Info>Ending Inventory: <Status ordered={true}>15</Status></Info>
                    <form> 
                        <label>
                            Enter amount of beers to purchase from Distributor:
                ...
                <Tab eventKey="status" title="Status of Supply Chain">
                    ...
                    <SupplyChain>Wholesaler: <Status ordered={false}>Has not Ordered</Status> </SupplyChain>
                    <SupplyChain>Retailer: <Status ordered={true}>Has Ordered</Status> </SupplyChain>
                </Tab>
